...
export const teluguAlphabets: AlphabetData = {
  vowels: {
    ...
    chars: [
      ...
      { char: 'ఋ', name: 'ru', english: 'ru' },
      { char: 'ౠ', name: 'ruu', english: 'rū' },
      { char: 'ఌ', name: 'lu', english: 'lu' },
      { char: 'ౡ', name: 'luu', english: 'lū' },
  ...
  consonants: {
    ...
    chars: [
      ...
      { char: 'ఙ', name: 'nga', english: 'ṅ' },
      // Cha-varga (చ వర్గం)
      { char: 'చ', name: 'cha', english: 'ch' },
      { char: 'ఛ', name: 'chha', english: 'chh' },
      { char: 'జ', name: 'ja', english: 'j' },
      { char: 'ఝ', name: 'jha', english: 'jh' },
      { char: 'ఞ', name: 'nya', english: 'ñ' },
      // Ta-varga (ట వర్గం — retroflex)
      { char: 'ట', name: 'tta', english: 'ṭ' },
      { char: 'ఠ', name: 'ttha', english: 'ṭh' },
      { char: 'డ', name: 'dda', english: 'ḍ' },
      { char: 'ఢ', name: 'ddha', english: 'ḍh' },
      { char: 'ణ', name: 'nna', english: 'ṇ' },
      // Ta-varga (త వర్గం — dental)
      { char: 'త', name: 'ta', english: 't' },
      { char: 'థ', name: 'tha', english: 'th' },
      { char: 'ద', name: 'da', english: 'd' },
      { char: 'ధ', name: 'dha', english: 'dh' },
      { char: 'న', name: 'na', english: 'n' },
      // Pa-varga (ప వర్గం)
      ...
      // Semi-vowels (అంతఃస్థాలు)
      { char: 'య', name: 'ya', english: 'y' },
      { char: 'ర', name: 'ra', english: 'r' },
      { char: 'ఱ', name: 'rra', english: 'rr' },
      { char: 'ల', name: 'la', english: 'l' },
      { char: 'ళ', name: 'lla', english: 'ḷ' },
      { char: 'ఴ', name: 'zha', english: 'zh' },
      { char: 'వ', name: 'va', english: 'v' },
      // Sibilants (ఉష్మాలు)
      { char: 'శ', name: 'sha', english: 'ś' },
      { char: 'ష', name: 'ssa', english: 'ṣ' },
      { char: 'స', name: 'sa', english: 's' },
      // Aspirant
      { char: 'హ', name: 'ha', english: 'h' },
      // Conjuncts
      { char: 'క్ష', name: 'ksha', english: 'kṣ' },
      { char: 'జ్ఞ', name: 'gna', english: 'jñ' },
    ]
  },
  ...
  gunihalu: {
    ...
    chars: [
      ...
      { char: 'ౄ', name: 'roo_sign', english: 'rū (ౄ)', keyword: 'కౄర (krūra) - cruel 😈' },
